...
const MailV2Icon: FC<IconProps> = (props: IconProps) => {
  const { size, color } = props;
  return (
    <svg height={size} version="1.1" viewBox="0 0 60 60" width={size} xmlns="http://www.w3.org/2000/svg">
...
MailV2Icon.defaultProps = {
  color: '#00afed',
  size: 24,
};

export default MailV2Icon;
